  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col bg-slate-50">
      ...
      <nav className="fixed inset-x-0 bottom-0 mx-auto flex max-w-md items-center gap-1 overflow-x-auto border-t border-slate-200 bg-white px-2 py-2 text-xs">
        ...
        <Link href="/vendedor/productos" className="flex flex-col items-center gap-0.5 px-2 py-1 font-semibold text-slate-700">
        ...
        <Link href="/vendedor/checklist" className="flex flex-col items-center gap-0.5 px-2 py-1 font-semibold text-slate-700">
          <span className="text-lg">📋</span> Revisión
        </Link>
      </nav>
    </div>
  );
